// types.hpp - Type definitions and device ID constants
// Originally from pico-crossing, extended with WaveBird/Joybus device flags
...
#define DEVICE_ID_CONTROLLER   0x0900   // Standard wired GC controller
#define DEVICE_ID_WAVEBIRD     0xA800   // WaveBird wireless receiver (base ID)
#define DEVICE_ID_KEYBOARD     0x0820   // GC keyboard

// Joybus device ID flags (from libjoybus)
#define JOYBUS_FLAG_DEVICE     0x0800   // Bit set on all GC devices
#define JOYBUS_FLAG_WIRELESS   0x8000   // WaveBird wireless flag
